...
module.exports = {
	    data: new SlashCommandBuilder()
            .setName('generate_db')
            .setDescription('WARNING: DO NOT USE IF NOT JOHNNY/CAMERON/ETH'),
	    async execute(interaction) {
            ...
            // Only let Johnny, Ethan or Cameron use this command
            if(!(user_id === "135261819173339138" || user_id === "222054888341897216" || user_id === "101101058528395264")){
                interaction.editReply("You probably shouldn't touch this one");
            }
            else{
